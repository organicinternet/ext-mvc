...
Ext.ux.MVC.Dispatcher = function(config) {
  ...
  this.dispatch = function(url) {
    ...
    var c = this.getControllerByName(((params[":controller"].indexOf('_') >= 0 || params[":controller"] == params[":controller"].toLowerCase()) ? String.camelize(params[":controller"]) : params[":controller"]) + "Controller");
